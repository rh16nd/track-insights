...
export const fr: Record<string, string> = {
  ...
  "howItWorks.s2.p1":
    "Le modèle apprend des podiums réels de chaque finale de Diamond League de **2018 à 2025** (2020 a été annulée). Ce sont de vrais résultats, tirés directement de World Athletics, pas l'avis de quiconque sur qui aurait dû gagner.",
  "howItWorks.s2.p2":
    "Pour chaque athlète en lice, le modèle calcule **14 signaux** à partir de sa vraie saison : sa meilleure marque de l'année et son record en carrière, sa régularité d'une réunion à l'autre, la tendance de sa forme, son nombre de courses, et son bilan **en confrontation directe avec ce plateau précis**. Une **forêt aléatoire**, un modèle qui pèse de nombreux signaux ensemble, transforme le tout en un seul chiffre : la chance de podium. Elle les pèse ensemble parce que les signaux s'influencent les uns les autres. Une superbe meilleure performance compte moins, par exemple, si l'athlète n'a presque pas couru de l'année.",
  "howItWorks.s2.p3":
