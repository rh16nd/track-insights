...
export const fr: Record<string, string> = {
  ...
  "ultimate.projection.flaggedHint":
    "Ces athlètes figurent toujours dans le plateau qualifié de World Athletics, et le chiffre à côté d’eux reste celui du modèle. Ce qui a changé, c’est qu’un titre de presse ou un compte rendu de résultats a mentionné une blessure, un abandon ou un forfait — une chose que le modèle ne peut pas savoir. Ils sont placés ici plutôt que supprimés, car une détection peut se tromper : touchez le badge pour lire le titre d’origine et en juger vous-même.",
